  ...
  return (
    <div className=" relative bg-black overflow-hidden">
      <div className="relative  z-10">
        <div className=" px-10 py-16 text-white w-10/12 mx-auto ">
          {/* logo */}
          <div className="my-8">
          ...
          <div className="flex items-center justify-between">
            ...
            {/*  */}
            <div className="px-4 py-8 bg-white/5 space-y-6 text-center w-1/3">
        ...
        <hr />
        <div className="text-white px-10 py-16 w-10/12 mx-auto flex items-center justify-between">
          <div className="">
            <p className="text-sm">
              <span> Terms</span>
